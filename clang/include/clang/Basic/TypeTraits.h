...
const char *CLANG_ABI getTraitName(TypeTrait T) LLVM_READONLY;
const char *CLANG_ABI getTraitName(ArrayTypeTrait T) LLVM_READONLY;
const char *CLANG_ABI getTraitName(UnaryExprOrTypeTrait T) LLVM_READONLY;

/// Return the spelling of the type trait \p TT. Never null.
const char *CLANG_ABI getTraitSpelling(TypeTrait T) LLVM_READONLY;
const char *CLANG_ABI getTraitSpelling(ArrayTypeTrait T) LLVM_READONLY;
const char *CLANG_ABI getTraitSpelling(UnaryExprOrTypeTrait T) LLVM_READONLY;

/// Return the arity of the type trait \p T.
unsigned CLANG_ABI getTypeTraitArity(TypeTrait T) LLVM_READONLY;
