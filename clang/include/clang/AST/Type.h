...
class CLANG_ABI ArrayParameterType : public ConstantArrayType {
  friend class ASTContext; // ASTContext creates these.
...
class CLANG_ABI HLSLAttributedResourceType : public Type, public llvm::FoldingSetNode {
public:
  struct Attributes {
...
class CLANG_ABI AutoType : public DeducedType {
  friend class ASTContext; // ASTContext creates these
