...
class CLANG_ABI NamespaceDecl : public NamedDecl, public DeclContext,
...
public:
  ...
  class CLANG_ABI DefaultedFunctionInfo final
...
class CLANG_ABI TopLevelStmtDecl : public Decl {
  friend class ASTDeclReader;
  friend class ASTDeclWriter;
