...
class LLVM_ABI VPIRInstruction : public VPRecipeBase {
  Instruction &I;
...
class LLVM_ABI VPWidenEVLRecipe : public VPWidenRecipe {
...
class LLVM_ABI VPWidenIntrinsicRecipe : public VPRecipeWithIRFlags {
...
class LLVM_ABI VPHistogramRecipe : public VPRecipeBase {
...
/// in reverse order.
class LLVM_ABI VPReverseVectorPointerRecipe : public VPRecipeWithIRFlags,
