...
namespace llvm {
LLVM_ABI_DATA cl::opt<bool> CheckBFIUnknownBlockQueries(
...
LLVM_ABI_DATA cl::opt<bool> UseIterativeBFIInference(
    "use-iterative-bfi-inference", cl::Hidden,
    cl::desc("Apply an iterative post-processing to infer correct BFI counts"));

LLVM_ABI_DATA cl::opt<unsigned> IterativeBFIMaxIterationsPerBlock(
...
LLVM_ABI_DATA cl::opt<double> IterativeBFIPrecision(
