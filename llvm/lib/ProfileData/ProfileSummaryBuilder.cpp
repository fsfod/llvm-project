...
namespace llvm {
LLVM_ABI_DATA cl::opt<bool> UseContextLessSummary(
...
// considered cold).
LLVM_ABI_DATA cl::opt<int> ProfileSummaryCutoffHot(
    "profile-summary-cutoff-hot", cl::Hidden, cl::init(990000),
    cl::desc("A count is hot if it exceeds the minimum count to"
             " reach this percentile of total counts."));

LLVM_ABI_DATA cl::opt<int> ProfileSummaryCutoffCold(
    "profile-summary-cutoff-cold", cl::Hidden, cl::init(999999),
    cl::desc("A count is cold if it is below the minimum count"
             " to reach this percentile of total counts."));

LLVM_ABI_DATA cl::opt<unsigned> ProfileSummaryHugeWorkingSetSizeThreshold(
...
LLVM_ABI_DATA cl::opt<unsigned> ProfileSummaryLargeWorkingSetSizeThreshold(
