...
LLVM_CLASS_ABI void ErrorInfoBase::anchor() {}
LLVM_CLASS_ABI char ErrorInfoBase::ID = 0;
LLVM_CLASS_ABI char ErrorList::ID = 0;
LLVM_CLASS_ABI void ECError::anchor() {}
LLVM_CLASS_ABI char ECError::ID = 0;
LLVM_CLASS_ABI char StringError::ID = 0;
LLVM_CLASS_ABI char FileError::ID = 0;
