...
LLVM_ABI AllocaInst *DemotePHIToStack(PHINode *P, Instruction *AllocaPoint = nullptr);
...
LLVM_ABI void ConvertDebugDeclareToDebugValue(DPValue *DPV, StoreInst *SI,
                                     DIBuilder &Builder);
...
LLVM_ABI void ConvertDebugDeclareToDebugValue(DPValue *DPV, LoadInst *LI,
                                     DIBuilder &Builder);
...
LLVM_ABI void ConvertDebugDeclareToDebugValue(DPValue *DPV, PHINode *LI,
                                     DIBuilder &Builder);
...
LLVM_ABI void combineMetadata(Instruction *K, const Instruction *J,
