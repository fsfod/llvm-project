...
class LLVM_ABI SinkAndHoistLICMFlags {
public:
...
LLVM_ABI SmallVector<DomTreeNode *, 16> collectChildrenInLoop(DomTreeNode *N,
                                                     const Loop *CurLoop);
...
LLVM_ABI Value *createAnyOfOp(IRBuilderBase &Builder, Value *StartVal, RecurKind RK,
...
/// Fast-math-flags are propagated using the IRBuilder's setting.
LLVM_ABI Value *createSimpleTargetReduction(IRBuilderBase &B, Value *Src,
                                   RecurKind RdxKind);

/// Create a target reduction of the given vector \p Src for a reduction of the
/// kind RecurKind::IAnyOf or RecurKind::FAnyOf. The reduction operation is
/// described by \p Desc.
LLVM_ABI Value *createAnyOfTargetReduction(IRBuilderBase &B, Value *Src,
...
LLVM_ABI Value *createTargetReduction(IRBuilderBase &B, const RecurrenceDescriptor &Desc,
                             Value *Src, PHINode *OrigPhi = nullptr);

/// Create an ordered reduction intrinsic using the given recurrence
/// descriptor \p Desc.
LLVM_ABI Value *createOrderedReduction(IRBuilderBase &B,
