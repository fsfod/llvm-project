...
class LLVM_ABI MemProfilerPass : public PassInfoMixin<MemProfilerPass> {
public:
...
class LLVM_ABI ModuleMemProfilerPass : public PassInfoMixin<ModuleMemProfilerPass> {
public:
...
class LLVM_ABI MemProfUsePass : public PassInfoMixin<MemProfUsePass> {
public:
