...
struct LLVM_ABI GlobalLayoutBuilder {
...
struct LLVM_ABI ByteArrayBuilder {
...
class LLVM_ABI LowerTypeTestsPass : public PassInfoMixin<LowerTypeTestsPass> {
