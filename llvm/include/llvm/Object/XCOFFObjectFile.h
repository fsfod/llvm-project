...
extern template Expected<ArrayRef<ExceptionSectionEntry32>> LLVM_TEMPLATE_ABI
XCOFFObjectFile::getExceptionEntries() const;
extern template Expected<ArrayRef<ExceptionSectionEntry64>> LLVM_TEMPLATE_ABI
XCOFFObjectFile::getExceptionEntries() const;
