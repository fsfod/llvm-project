...
LLVM_ABI unsigned ComputeLinearIndex(Type *Ty,
...
///
LLVM_ABI void ComputeValueVTs(const TargetLowering &TLI, const DataLayout &DL, Type *Ty,
...
LLVM_ABI bool isInTailCallPosition(const CallBase &Call, const TargetMachine &TM,
...
/// optimization.
LLVM_ABI bool returnTypeIsEligibleForTailCall(const Function *F, const Instruction *I,
                                     const ReturnInst *Ret,
                                     const TargetLoweringBase &TLI,
                                     bool ReturnsFirstArg = false);
