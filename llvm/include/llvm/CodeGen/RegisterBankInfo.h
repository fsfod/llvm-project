...
public:
  ...
  struct LLVM_CLASS_ABI PartialMapping {
  ...
  struct LLVM_CLASS_ABI ValueMapping {
  ...
  class LLVM_CLASS_ABI InstructionMapping {
  ...
  class LLVM_CLASS_ABI OperandsMapper {
    ...
    LLVM_ABI_DATA_IMPORT static const int DontKnowIdx;
...
public:
  ...
  LLVM_ABI_DATA_IMPORT static const unsigned DefaultMappingID;

  /// Identifier used when the related instruction mapping instance
  /// is generated by the default constructor.
  /// Make sure not to use that identifier.
  LLVM_ABI_DATA_IMPORT static const unsigned InvalidMappingID;
