...
public:
  ...
  struct LLVM_ABI MachineArgument : public DiagnosticInfoOptimizationBase::Argument {
...
class LLVM_ABI MachineOptimizationRemarkEmitter {
public:
...
/// The analysis pass
class LLVM_ABI MachineOptimizationRemarkEmitterAnalysis
