...
namespace llvm {
  ...
  LLVM_ABI FunctionPass *createAtomicExpandPass();
  ...
  LLVM_ABI extern char &EdgeBundlesID;
  ...
  LLVM_ABI extern char &RAGreedyID;
  ...
  LLVM_ABI FunctionPass *createFastRegisterAllocator(RegClassFilterFunc F,
                                            bool ClearVirtRegs);
  ...
  LLVM_ABI FunctionPass *createBasicRegisterAllocator(RegClassFilterFunc F);

  /// Greedy register allocation pass - This pass implements a global register
  /// allocator for optimized builds.
  ///
  LLVM_ABI FunctionPass *createGreedyRegisterAllocator();
  LLVM_ABI FunctionPass *createGreedyRegisterAllocator(RegClassFilterFunc F);
  ...
  LLVM_ABI extern char &TailDuplicateID;
  ...
  LLVM_ABI extern char &EarlyTailDuplicateID;
  ...
  LLVM_ABI extern char &EarlyIfConverterID;
  ...
  LLVM_ABI extern char &StackColoringID;
  ...
  LLVM_ABI FunctionPass *createIfConverter(
  ...
  LLVM_ABI extern char &MachineCSEID;
  ...
  LLVM_ABI extern char &MachineSinkingID;
  ...
  LLVM_ABI extern char &PeepholeOptimizerID;

  /// OptimizePHIs - This pass optimizes machine instruction PHIs
  /// to take advantage of opportunities created during DAG legalization.
  LLVM_ABI extern char &OptimizePHIsID;
  ...
  /// predicate mask.
  LLVM_ABI FunctionPass *createExpandVectorPredicationPass();

  // Expands large div/rem instructions.
  LLVM_ABI FunctionPass *createExpandLargeDivRemPass();

  // Expands large div/rem instructions.
  LLVM_ABI FunctionPass *createExpandLargeFpConvertPass();
  ...
  LLVM_ABI FunctionPass *createEHContGuardCatchretPass();
