...
class LLVM_ABI AccelTableBase {
public:
  using HashFn = uint32_t(StringRef);

  /// Represents a group of entries with identical name (and hence, hash value).
  struct LLVM_ABI HashData {
...
class LLVM_ABI DWARF5AccelTableData : public AccelTableData {
public:
...
class LLVM_ABI DebugNamesAbbrev : public FoldingSetNode {
public:
  uint32_t DieTag;
  uint32_t Number;
...
class LLVM_ABI DWARF5AccelTable : public AccelTable<DWARF5AccelTableData> {
