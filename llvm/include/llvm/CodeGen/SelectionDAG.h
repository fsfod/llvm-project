...
public:
  ...
  struct LLVM_CLASS_ABI DAGUpdateListener {
  ...
  struct LLVM_CLASS_ABI DAGNodeDeletedListener : public DAGUpdateListener {
  ...
  struct LLVM_CLASS_ABI DAGNodeInsertedListener : public DAGUpdateListener {
