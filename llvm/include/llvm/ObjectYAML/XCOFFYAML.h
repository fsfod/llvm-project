...
template <> struct LLVM_CLASS_ABI ScalarEnumerationTraits<XCOFF::DwarfSectionSubtypeFlags> {
...
template <> struct LLVM_CLASS_ABI ScalarEnumerationTraits<XCOFF::SymbolType> {
