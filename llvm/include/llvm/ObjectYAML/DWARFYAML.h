...
template <> struct LLVM_CLASS_ABI MappingTraits<DWARFYAML::DebugNamesSection> {
  static void mapping(IO &IO, DWARFYAML::DebugNamesSection &);
};
template <> struct LLVM_CLASS_ABI MappingTraits<DWARFYAML::DebugNameEntry> {
  static void mapping(IO &IO, DWARFYAML::DebugNameEntry &);
};
template <> struct LLVM_CLASS_ABI MappingTraits<DWARFYAML::DebugNameAbbreviation> {
  static void mapping(IO &IO, DWARFYAML::DebugNameAbbreviation &);
};
template <> struct LLVM_CLASS_ABI MappingTraits<DWARFYAML::IdxForm> {
