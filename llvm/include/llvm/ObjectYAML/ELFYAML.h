...
template <> struct LLVM_CLASS_ABI MappingTraits<ELFYAML::BBAddrMapEntry::BBRangeEntry> {
...
template <> struct LLVM_CLASS_ABI MappingTraits<ELFYAML::PGOAnalysisMapEntry> {
  static void mapping(IO &IO, ELFYAML::PGOAnalysisMapEntry &Rel);
};

template <> struct LLVM_CLASS_ABI MappingTraits<ELFYAML::PGOAnalysisMapEntry::PGOBBEntry> {
  static void mapping(IO &IO, ELFYAML::PGOAnalysisMapEntry::PGOBBEntry &Rel);
};

template <>
struct LLVM_CLASS_ABI MappingTraits<ELFYAML::PGOAnalysisMapEntry::PGOBBEntry::SuccessorEntry> {
  static void
  mapping(IO &IO,
