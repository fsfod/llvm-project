...
template <> struct LLVM_ABI VarStreamArrayExtractor<codeview::InlineeSourceLine> {
...
class LLVM_ABI DebugInlineeLinesSubsectionRef final : public DebugSubsectionRef {
