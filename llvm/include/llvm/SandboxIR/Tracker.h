...
class LLVM_ABI IRSnapshotChecker {
  Context &Ctx;
...
class LLVM_ABI UseSet : public IRChangeBase {
  Use U;
  Value *OrigV = nullptr;
...
class LLVM_ABI UseSwap : public IRChangeBase {
  Use ThisUse;
  Use OtherUse;
