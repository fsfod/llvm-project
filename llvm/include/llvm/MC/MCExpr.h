...
class LLVM_ABI MCConstantExpr : public MCExpr {
  int64_t Value;
...
class LLVM_ABI MCSymbolRefExpr : public MCExpr {
public:
...
class LLVM_ABI MCUnaryExpr : public MCExpr {
public:
  enum Opcode {
...
class LLVM_ABI MCBinaryExpr : public MCExpr {
public:
  enum Opcode {
    Add,  ///< Addition.
    And,  ///< Bitwise and.
