...
class LLVM_ABI OpenMPIRBuilderConfig {
public:
...
/// a target entry.
struct LLVM_ABI TargetRegionEntryInfo {
...
class LLVM_ABI OffloadEntriesInfoManager {
...
class LLVM_ABI OpenMPIRBuilder {
public:
...
class LLVM_ABI CanonicalLoopInfo {
