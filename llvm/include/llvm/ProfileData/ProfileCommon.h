...
class LLVM_ABI ProfileSummaryBuilder {
private:
...
class LLVM_ABI InstrProfSummaryBuilder final : public ProfileSummaryBuilder {
...
class LLVM_ABI SampleProfileSummaryBuilder final : public ProfileSummaryBuilder {
public:
