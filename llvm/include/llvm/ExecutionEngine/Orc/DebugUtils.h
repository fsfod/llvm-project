...
LLVM_ABI raw_ostream &operator<<(raw_ostream &OS, const SymbolStringPtr &Sym);

/// Render a NonOwningSymbolStringPtr.
LLVM_ABI raw_ostream &operator<<(raw_ostream &OS, NonOwningSymbolStringPtr Sym);
