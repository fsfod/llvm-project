...
public:
  ...
  struct HeaderOptions {
    ...
    struct LLVM_CLASS_ABI BuildVersionOpts {
...
private:
  ...
  class LLVM_CLASS_ABI MachOPlatformPlugin : public ObjectLinkingLayer::Plugin {
  public:
...
class LLVM_CLASS_ABI SimpleMachOHeaderMU : public MaterializationUnit {
public:
