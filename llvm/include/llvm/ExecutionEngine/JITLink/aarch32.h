...
struct LLVM_CLASS_ABI FixupInfoBase {
...
class LLVM_CLASS_ABI GOTBuilder : public TableManager<GOTBuilder> {
public:
...
class LLVM_CLASS_ABI StubsManager_prev7 {
public:
...
class LLVM_CLASS_ABI StubsManager_v7 {
public:
