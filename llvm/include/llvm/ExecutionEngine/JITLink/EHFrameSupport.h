...
class LLVM_ABI EHFrameCFIBlockInspector {
public:
...
class LLVM_ABI EHFrameRegistrar {
public:
...
class LLVM_ABI InProcessEHFrameRegistrar final : public EHFrameRegistrar {
public:
...
LLVM_ABI LinkGraphPassFunction
