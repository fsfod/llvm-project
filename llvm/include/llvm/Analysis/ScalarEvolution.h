...
public:
  ...
  struct LLVM_CLASS_ABI ExitLimit {
...
private:
  ...
  /// Value is deleted.
  class LLVM_CLASS_ABI SCEVCallbackVH final : public CallbackVH {
    ScalarEvolution *SE;
  ...
  ///
  class LLVM_CLASS_ABI BackedgeTakenInfo {
  ...
  class LLVM_CLASS_ABI ExitLimitCache {
