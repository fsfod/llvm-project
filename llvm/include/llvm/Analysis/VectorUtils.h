...
LLVM_ABI bool isVectorIntrinsicWithScalarOpAtArg(Intrinsic::ID ID,
...
LLVM_ABI bool isVectorIntrinsicWithStructReturnOverloadAtField(Intrinsic::ID ID,
                                                      int RetIdx);
...
class LLVM_ABI InterleavedAccessInfo {
public:
