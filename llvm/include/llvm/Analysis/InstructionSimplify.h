...
LLVM_ABI Value *simplifyICmpInst(unsigned Predicate, Value *LHS, Value *RHS,
                        const SimplifyQuery &Q);

/// Given operands for an FCmpInst, fold the result or return null.
LLVM_ABI Value *simplifyFCmpInst(unsigned Predicate, Value *LHS, Value *RHS,
...
LLVM_ABI Value *simplifyCmpInst(unsigned Predicate, Value *LHS, Value *RHS,
                       const SimplifyQuery &Q);
