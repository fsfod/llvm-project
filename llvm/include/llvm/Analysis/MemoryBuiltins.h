...
class LLVM_ABI ObjectSizeOffsetVisitor
...
struct LLVM_ABI SizeOffsetValue : public SizeOffsetType<Value *, SizeOffsetValue> {
...
class LLVM_ABI ObjectSizeOffsetEvaluator
