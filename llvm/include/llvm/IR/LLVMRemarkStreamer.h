...
/// objects.
class LLVM_ABI LLVMRemarkStreamer {
...
struct LLVM_ABI LLVMRemarkSetupFileError
...
struct LLVM_ABI LLVMRemarkSetupPatternError
...
struct LLVM_ABI LLVMRemarkSetupFormatError
