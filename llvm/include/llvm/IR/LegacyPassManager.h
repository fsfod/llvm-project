...
LLVM_C_ABI bool debugPassSpecified();
...
/// it is.
class LLVM_C_ABI PassManagerBase {
public:
...
class LLVM_C_ABI PassManager : public PassManagerBase {
public:
...
class LLVM_C_ABI FunctionPassManager : public PassManagerBase {
public:
