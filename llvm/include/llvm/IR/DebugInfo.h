...
LLVM_ABI TinyPtrVector<DPValue *> findDPVDeclares(Value *V);

/// Finds the llvm.dbg.value intrinsics describing a value.
LLVM_ABI void findDbgValues(SmallVectorImpl<DbgValueInst *> &DbgValues,
                   Value *V, SmallVectorImpl<DPValue *> *DPValues = nullptr);

/// Finds the debug info intrinsics describing a value.
LLVM_ABI void findDbgUsers(SmallVectorImpl<DbgVariableIntrinsic *> &DbgInsts,
                  Value *V, SmallVectorImpl<DPValue *> *DPValues = nullptr);
...
LLVM_ABI DebugLoc getDebugValueLoc(DPValue *DPV);
...
/// used by the CUs.
class LLVM_ABI DebugInfoFinder {
public:
...
class LLVM_ABI AssignmentTrackingPass : public PassInfoMixin<AssignmentTrackingPass> {
