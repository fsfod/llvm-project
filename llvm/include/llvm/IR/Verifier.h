...
class LLVM_ABI VerifierAnalysis : public AnalysisInfoMixin<VerifierAnalysis> {
...
class LLVM_ABI VerifierPass : public PassInfoMixin<VerifierPass> {
  bool FatalErrors;
