 ...
 * \since prior to LTO_API_VERSION=3
 */
LLVM_C_ABI extern lto_bool_t lto_module_is_object_file_in_memory(const void *mem,
                                                      size_t length);
 ...
 * \since prior to LTO_API_VERSION=3
 */
LLVM_C_ABI extern lto_module_t
 ...
 * \since prior to LTO_API_VERSION=3
 */
LLVM_C_ABI extern unsigned int
 ...
 * \since prior to LTO_API_VERSION=3
 */
LLVM_C_ABI extern lto_symbol_attributes
 ...
 */
LLVM_C_ABI extern lto_bool_t lto_module_get_macho_cputype(lto_module_t mod,
 ...
 */
LLVM_C_ABI extern lto_bool_t lto_module_has_ctor_dtor(lto_module_t mod);
/**
 * Diagnostic severity.
 *
 ...
 * \since LTO_API_VERSION=7
 */
LLVM_C_ABI extern void lto_codegen_set_diagnostic_handler(lto_code_gen_t,
 ...
 * \since prior to LTO_API_VERSION=3
 */
LLVM_C_ABI extern lto_code_gen_t
 ...
 */
LLVM_C_ABI extern void lto_set_debug_options(const char *const *options, int number);
 ...
 */
LLVM_C_ABI extern void lto_codegen_debug_options_array(lto_code_gen_t cg,
...
/**
  ...
  */
LLVM_C_ABI extern lto_input_t lto_input_create(const void *buffer,
                                    size_t buffer_size,
                                    const char *path);
...
/**
  ...
  * \since LTO_API_VERSION=24
  */
LLVM_C_ABI extern void lto_input_dispose(lto_input_t input);
...
/**
  ...
  * \since LTO_API_VERSION=24
  */
LLVM_C_ABI extern unsigned lto_input_get_num_dependent_libraries(lto_input_t input);
...
/**
  ...
  * \since LTO_API_VERSION=24
  */
LLVM_C_ABI extern const char * lto_input_get_dependent_library(lto_input_t input,
                                                    size_t index,
                                                    size_t *size);
 ...
 */
LLVM_C_ABI extern const char *const *lto_runtime_lib_symbols_list(size_t *size);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern thinlto_code_gen_t thinlto_create_codegen(void);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_dispose(thinlto_code_gen_t cg);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_add_module(thinlto_code_gen_t cg,
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_process(thinlto_code_gen_t cg);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern unsigned int thinlto_module_get_num_objects(thinlto_code_gen_t cg);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern LTOObjectBuffer thinlto_module_get_object(thinlto_code_gen_t cg,
                                                 unsigned int index);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern lto_bool_t thinlto_codegen_set_pic_model(thinlto_code_gen_t cg,
                                                lto_codegen_model);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_set_savetemps_dir(thinlto_code_gen_t cg,
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_set_cpu(thinlto_code_gen_t cg, const char *cpu);
 ...
 */
LLVM_C_ABI extern void thinlto_codegen_disable_codegen(thinlto_code_gen_t cg,
                                            lto_bool_t disable);
 ...
 * \since LTO_API_VERSION=19
 */
LLVM_C_ABI extern void thinlto_codegen_set_codegen_only(thinlto_code_gen_t cg,
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_debug_options(const char *const *options, int number);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern lto_bool_t lto_module_is_thinlto(lto_module_t mod);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_add_must_preserve_symbol(thinlto_code_gen_t cg,
                                                     const char *name,
                                                     int length);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_add_cross_referenced_symbol(thinlto_code_gen_t cg,
                                                        const char *name,
                                                        int length);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_set_cache_dir(thinlto_code_gen_t cg,
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_set_cache_pruning_interval(thinlto_code_gen_t cg,
                                                       int interval);
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_set_final_cache_size_relative_to_available_space(
 ...
 * \since LTO_API_VERSION=18
 */
LLVM_C_ABI extern void thinlto_codegen_set_cache_entry_expiration(thinlto_code_gen_t cg,
                                                       unsigned expiration);
 ...
 */
LLVM_C_ABI extern void thinlto_codegen_set_cache_size_bytes(thinlto_code_gen_t cg,
 ...
 * \since LTO_API_VERSION=22
 */
LLVM_C_ABI extern void thinlto_codegen_set_cache_size_files(thinlto_code_gen_t cg,
