 ...
 */
LLVM_C_ABI LLVMValueRef LLVMDIBuilderInsertDeclareBefore(
 ...
 */
LLVM_C_ABI LLVMValueRef LLVMDIBuilderInsertDeclareAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Storage, LLVMMetadataRef VarInfo,
 ...
 * \param Instr       Instruction acting as a location for the new intrinsic.
 */
LLVM_C_ABI LLVMValueRef LLVMDIBuilderInsertDbgValueBefore(LLVMDIBuilderRef Builder,
                                               LLVMValueRef Val,
 ...
 * \param Block       Basic block acting as a location for the new intrinsic.
 */
LLVM_C_ABI LLVMValueRef LLVMDIBuilderInsertDbgValueAtEnd(LLVMDIBuilderRef Builder,
                                              LLVMValueRef Val,
                                              LLVMMetadataRef VarInfo,
                                              LLVMMetadataRef Expr,
                                              LLVMMetadataRef DebugLoc,
