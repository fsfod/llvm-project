 ...
 * \param Instr       Instruction acting as a location for the new intrinsic.
 */
LLVM_C_ABI LLVMValueRef LLVMDIBuilderInsertDeclareIntrinsicBefore(
 ...
 */
LLVM_C_ABI LLVMDbgRecordRef LLVMDIBuilderInsertDeclareAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Storage, LLVMMetadataRef VarInfo,
 ...
 * \param Block       Basic block acting as a location for the new intrinsic.
 */
LLVM_C_ABI LLVMValueRef LLVMDIBuilderInsertDeclareIntrinsicAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Storage, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMBasicBlockRef Block);
/**
 * Soon to be deprecated.
 ...
 * \param Instr       Instruction acting as a location for the new intrinsic.
 */
LLVM_C_ABI LLVMValueRef LLVMDIBuilderInsertDbgValueIntrinsicBefore(
 ...
 * \param Block       Basic block acting as a location for the new intrinsic.
 */
LLVM_C_ABI LLVMDbgRecordRef LLVMDIBuilderInsertDbgValueAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Val, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMBasicBlockRef Block);
/**
 * Soon to be deprecated.
 ...
 * \param Block       Basic block acting as a location for the new intrinsic.
 */
LLVM_C_ABI LLVMValueRef LLVMDIBuilderInsertDbgValueIntrinsicAtEnd(
    LLVMDIBuilderRef Builder, LLVMValueRef Val, LLVMMetadataRef VarInfo,
    LLVMMetadataRef Expr, LLVMMetadataRef DebugLoc, LLVMBasicBlockRef Block);
/**
 * Soon to be deprecated.
